...
import { EditHealthPolicy } from "components/dashboard/customer/AddEdit"

const HealthPolicyEdit: FC = () => {
    const { id } = useParams()
    ...
    return (
        <>
            <Helmet>
                <title>Edit Policy Details | {CRM.name}</title>
            </Helmet>
            <Box
                sx={{
...
export default HealthPolicyEdit
