...
import { EditDependent } from "components/dashboard/customer/AddEdit"
import ChevronRightIcon from "icons/ChevronRight"
import { CRM } from "lib/constants"
import { useGetCustomerById } from "lib/useFirestore"

const DependentEdit: FC = () => {
    const { id } = useParams()
    ...
    return (
        <>
            <Helmet>
                <title>Edit Dependent | {CRM.name}</title>
            </Helmet>
            <Box
                sx={{
            ...
            >
                <Container maxWidth={false}>
                    ...
                    <Box mt={3}>
                        <EditDependent customer={customer} />
                    </Box>
                </Container>
            </Box>
        </>
